    ...
    (function ($) {
        $(document).ready(function() {
			...
			if (member_type == 'cooperative') {
				output += 'Year 1 Dues amount: $' + formatDollar(formula(ilec, dues_2017, clec, false, false)) + '<br>';
				output += 'Year 2 Dues amount: $' + formatDollar(formula(ilec, dues_2017, clec, dues_2018, false)) + '<br>';
				output += 'Year 3 Dues amount: $' + formatDollar(formula(ilec, dues_2017, clec, false, dues_2019)) + '<br>';
			}
...
function formula(ilec, dues_2017, clec, dues_2018, dues_2019) {
	...
	if(ilec > 0) {
		if (dues_2018 === false && dues_2019 === false) {
		  	var dues_2017_new = dues_2017 * 1.10;
