...
#*     **Important Note: The remote-host option
...
#
# File Sync
#   drush rsync @source-alias:%files/optional/subfolder @destination-alias:%files/optional/subfolder
#
# Files Sync with exclusions
#   drush rsync @stage:%files @local:%files --exclude-paths=php/:styles/:css/:js/:tmp/ --delete
#
# Cache Rebuild (remotely)
#   drush @stage cr
#

$aliases["prod"] = array (
  'remote-host' => '938elmp01.blackmesh.com',
  'remote-user' => '938e',
  'root' => '/var/www/ntca.org/htdocs/drupal/docroot',
  'uri' => 'http://ntca.org',
  'path-aliases' =>
  array (
    '%drush' => '/opt/scripts/drush8',
    '%site' => 'sites/default/',
  ),
);
...
$aliases["qa"] = array (
  'remote-host' => '938elmp02.blackmesh.com',
  'remote-user' => '938e',
  'root' => '/var/www/qa.ntca.org/htdocs/drupal/docroot',
  'uri' => 'http://qa.ntca.org',
  'path-aliases' =>
  array (
    '%drush' => '/opt/scripts/drush8',
    '%site' => 'sites/default/',
...
$aliases["stage"] = array (
  'remote-host' => '938elmp02.blackmesh.com',
  'remote-user' => '938e',
  'root' => '/var/www/stage.ntca.org/htdocs/drupal/docroot',
  'uri' => 'http://stage.ntca.org',
  'path-aliases' =>
  array (
    '%drush' => '/opt/scripts/drush8',
    '%site' => 'sites/default/',
...
$aliases["local"] = array (
  'root' => '/var/www/site/drupal/docroot',
  'uri' => 'http://ntca.localhost',
  'path-aliases' =>
  array (
    '%drush' => '/opt/scripts/drush8',
    '%site' => 'sites/default/',
